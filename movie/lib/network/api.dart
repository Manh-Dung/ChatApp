...
// import '../utils/share_storage.dart';
...
//         // var accessToken = ShareStorage.storage.read(AppConfig.ACCESS_TOKEN_KEY);
//         var accessToken = ShareStorage.storage.get(AppConfig.ACCESS_TOKEN_KEY);
//         var refreshToken =
//             ShareStorage.storage.get(AppConfig.REFRESH_TOKEN_KEY);
//
...
//             JwtDecoder.isExpired(accessToken as String);
//         final refreshTokenHasExpired =
//             JwtDecoder.isExpired(refreshToken as String);
//
//         var _refreshed = true;
//
...
// //
//         if (_refreshed) {
//           accessToken = ShareStorage.storage.get(AppConfig.ACCESS_TOKEN_KEY);
//           refreshToken = ShareStorage.storage.get(AppConfig.REFRESH_TOKEN_KEY);
...
//             .setString(AppConfig.ACCESS_TOKEN_KEY, newAccessToken);
//         await ShareStorage.storage
//             .setString(AppConfig.REFRESH_TOKEN_KEY, newRefreshToken);
//
//         return true;
...
//
//     await ShareStorage.storage.clear();
//     // ShareStorage.storage.write(AppConfig.ACCESS_TOKEN_KEY, true);
